 ...
 */
public class TrajectoryAvgSpeedListener implements UpdateListener{

    static Logger LOG = Logger.getLogger(TrajectoryAvgSpeedListener.class);    
    
    @Override
    public void update(EventBean[] ebs, EventBean[] ebs1) {

        for(EventBean eb : ebs){
            SpeedFunction.newCurrentSpeed((String) eb.get("id"), (Long) eb.get("timestamp"), (Double)eb.get("speed"));
        }
    }
}
