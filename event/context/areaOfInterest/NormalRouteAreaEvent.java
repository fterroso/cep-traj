 ...
 */
public class NormalRouteAreaEvent extends AreaOfInterestEvent{
    
    public NormalRouteAreaEvent(){
        setType(AreaOfInterestType.NORMAL_ROUTE);
    }
    
    public static NormalRouteAreaEvent fromAreaOfInterest(AreaOfInterestEvent area){
        
        NormalRouteAreaEvent normalRoute = new NormalRouteAreaEvent();
